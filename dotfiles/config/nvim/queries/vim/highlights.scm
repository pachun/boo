; Workaround for Arch neovim 0.11.5 mismatched treesitter parsers/queries
; Remove this file when upstream is fixed: https://github.com/neovim/neovim/issues/34113
